...
public class Tests {
	...
	public static void testBagRemoveAllOccurencesSpeed() {
		...
		testBagRemoveAllSpeed(slowOrderedBag, normalOrderedBag, 200);
		System.out.println("");
		...
		testBagRemoveAllSpeed(slowOrderedBagWithoutRepetition, normalOrderedBagWithoutRepetition, 2000);
		System.out.println("");
	}

	private static void testBagRemoveAllSpeed(SimpleBag normal, SimpleBag faster, int times) {
		...
		while (toDelete.size() > 0) {
			...
			if (!bagSame(normal, faster)) {
				...
				System.out.println("normal: " + normal.theBag);
				System.out.println("faster: " + faster.theBag);
				System.out.println("toRemove:" + toDelete.get(toDelete.size() / 2));
				return;
			}
