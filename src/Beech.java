...
public class Beech extends Tree {
	//The beech is a kind of tree, and therefore extends Tree. It has no special traits compare to other trees, 
	//and is therefore simply an initialization of a Tree, with the traits described below:
	/**
	 * A beech tree, which has the normal traits of a tree, is cyan colored, and grows the fastest of all the trees. 
